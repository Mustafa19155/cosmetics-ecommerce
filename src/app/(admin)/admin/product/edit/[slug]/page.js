...
const getData = async () => {
  return {
    name: "Product Name",
    description:
      "NARS foundation is a makeup must-have, known for its impeccable coverage and luxurious finish. With a diverse shade range to suit every skin tone, it effortlessly evens out complexion.",
    price: 700,
    images: [
...
const Page = async () => {
  ...
  return (
    <div>
      <ManageProduct product={data} categories={categories} />
    </div>
  );
};
