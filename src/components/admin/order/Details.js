...
const Details = ({ order }) => {
  return (
    <div>
      <div className="bg-white shadow-cart-wrapper flex items-center justify-between flex-wrap p-8">
        <div className="flex items-center gap-20 mt-10 w-[60%]">
          <p className="font-bold w-[20%] whitespace-nowrap">Username</p>
          <p className="text-gray-500">{order.userDetails.username}</p>
        </div>
        <div className="flex items-center gap-20 mt-10 w-[40%]">
