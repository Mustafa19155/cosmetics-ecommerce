...
export default function Navbar() {
  ...
  return (
    <div className="flex justify-between py-5 relative z-10 px-5">
      <Image src={HamIcon} />
      ...
      />
      {showNavDrop && (
        <div className="flex lg:hidden flex-col absolute bg-white w-full mt-5 p-4 rounded-lg shadow-2xl max-w-screen left-0">
